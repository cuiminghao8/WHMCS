...
<div id="order-flathost">
                ...
                <tr class="carttableproduct">
                    <td>
                        ...
                        {if $product.configoptions}
                            ...
                            {/foreach}
                        {/if}
                        <a href="{$smarty.server.PHP_SELF}?a=confproduct&i={$num}" class="label label-info">{$LANG.carteditproductconfig}</a>
                        <a href="#" onclick="removeItem('p','{$num}');return false" class="label label-danger">{$LANG.cartremove}</a>
                        {if $product.allowqty}
                        <br /><br />
            ...
            {foreach key=num item=addon from=$addons}
                <tr class="carttableproduct">
                    <td>
                        ...
                        <a href="#" onclick="removeItem('a','{$num}');return false" class="label label-danger">{$LANG.cartremove}</a>
                    </td>
                    <td class="text-center"><strong>{$addon.pricingtext}</strong></td>
                </tr>
            {/foreach}
            ...
            {foreach key=num item=domain from=$domains}
                <tr class="carttableproduct">
                    <td>
                        ...
                        <a href="{$smarty.server.PHP_SELF}?a=confdomains" class="label label-info">{$LANG.cartconfigdomainextras}</a>
                        <a href="#" onclick="removeItem('d','{$num}');return false" class="label label-danger">{$LANG.cartremove}</a>
                    </td>
                    <td class="text-center">
            ...
            {foreach key=num item=domain from=$renewals}
                <tr class="carttableproduct">
                    <td>
                        ...
                        {if $domain.emailforwarding}&nbsp;&raquo; {$LANG.domainemailforwarding}<br />{/if}
                        {if $domain.idprotection}&nbsp;&raquo; {$LANG.domainidprotection}<br />{/if}
                        <a href="#" onclick="removeItem('r','{$num}');return false" class="label label-danger">{$LANG.cartremove}</a>
                    </td>
                    <td class="text-center">
                        <strong>{$domain.price}</strong>
                    </td>
    ...
    {if $cartitems!=0}
        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" id="mainfrm">
            ...
            <div class="signuptype{if !$loggedin && $custtype neq "existing"} active{/if}"{if !$loggedin} id="newcust"{/if}>{$LANG.newcustomer}</div><div class="signuptype{if $custtype eq "existing" && !$loggedin || $loggedin} active{/if}" id="existingcust">{$LANG.existingcustomer}</div>
            <div class="clear"></div>
