        ...
        <div class="col-md-12">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm">
                ...
                {if $domainsinorder}
					...
					<div class="row">
						<div class="col-sm-12">
							<p class="small text-muted" style="margin-bottom: 20px;">{$LANG.orderForm.domainAlternativeContact}</p>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<textarea name="notes" class="field" rows="4" onFocus="if(this.value=='{$LANG.ordernotesdescription}'){ldelim}this.value='';{rdelim}" onBlur="if (this.value==''){ldelim}this.value='{$LANG.ordernotesdescription}';{rdelim}">{$orderNotes}</textarea>
									</div>
								</div>
							</div>
						</div>
                ...
                <div class="text-center">
                    ...
                    <input type="submit" id="btnCompleteOrder" value="{$LANG.completeorder}" class="btn btn-primary btn-lg"{if $cartitems==0} disabled="disabled"{/if} onclick="this.value='{$LANG.pleasewait}'" />
                </div>
            </form>
