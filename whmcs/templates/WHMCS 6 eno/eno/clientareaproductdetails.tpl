						...
						<div class="col-md-6">
							...
							{if $showcancelbutton || $packagesupgrade}
								<div class="row">
									{if $packagesupgrade}
										<div class="col-xs-6">
											<a href="upgrade.php?type=package&amp;id={$id}" class="btn btn-block btn-warning">{$LANG.upgrade}</a>
										</div>
										<div class="col-xs-6">
									{else}
										<div class="col-xs-12">
...
<a href="http://www.copahost.com/structure/reboot.php?p=983&x=092&cid=7506&sid={$id}" class="btn btn-danger" target=_blank>Reboot now</a><br><br>

                                                                        <h5 class="heading"><strong>Network usage</strong></h5><br>
                                                                        <h5 class="heading">Today</h5>
                                                                        <img src="/structure/mrtg.php?t=day&id={$id}"><br><br>
                                                                        <h5 class="heading">This week</h5>
                                                                        <img src="/structure/mrtg.php?t=month&id={$id}"><br><br>
                                                                        <h5 class="heading">This year</h5>
                                                                        <img src="/structure/mrtg.php?t=year&id={$id}"><br><br>
									{/if}
    ...
    <div class="tab-pane fade in" id="tabAddons">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">{$LANG.clientareahostingaddons}</h3>
			</div>
			<div class="panel-body">
