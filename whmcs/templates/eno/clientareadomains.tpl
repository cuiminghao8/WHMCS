    ...
    <div class="tab-pane fade in active" id="tabOverview">
        ...
        <form id="domainForm" method="post" action="clientarea.php?action=bulkdomain">
            ...
            <div class="table-container clearfix">
                <table id="tableDomainsList" class="datatable table table-hover table-bordered table-primary eno-table hidden">
                    <thead>
                        <tr>
                    ...
                    {foreach key=num item=domain from=$domains}
                        <tr>
                            <td class="col-small center">
                                <input type="checkbox" class="tc" name="domids[]" class="domids stopEventBubble" value="{$domain.id}" />
