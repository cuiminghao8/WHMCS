...
<div class="portlet padding-all">
	<div class="portlet-heading large-heading">
		<div class="portlet-title">
			<h4><span class="text-uppercase text-primary">{$department}</span></h4>
		</div>
...
<form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form" class="form-horizontal">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<textarea name="message" id="inputMessage" rows="12" class="col-xs-12 col-sm-8">{$message}</textarea>
		</div>
    </div>
