...
<ul id="menu">
<li class="navbar"><a class="navlink first" class="navlink first" class="navlink first" id="Menu-Clients" {if in_array("List Clients",$admin_perms)}href="clients.php"{/if} title="Clients">{$_ADMINLANG.clients.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Orders" {if in_array("View Orders",$admin_perms)}href="orders.php"{/if} title="Orders">{$_ADMINLANG.orders.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Billing" {if in_array("List Transactions",$admin_perms)}href="transactions.php"{/if} title="Billing">{$_ADMINLANG.billing.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Support" {if in_array("Support Center Overview",$admin_perms)}href="supportcenter.php"{/if} title="Support">{$_ADMINLANG.support.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Reports" title="Reports" href="reports.php">{$_ADMINLANG.reports.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Utilities" title="Utilities" href="">{$_ADMINLANG.utilities.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Addons" title="Addons" href="addonmodules.php">{$_ADMINLANG.utilities.addonmodules}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Setup" title="Setup" href="">{$_ADMINLANG.setup.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Help" title="Help" href="">{$_ADMINLANG.help.title}</a>
  <ul>
