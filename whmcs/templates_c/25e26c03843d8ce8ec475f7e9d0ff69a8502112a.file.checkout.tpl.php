<?php /* Smarty version Smarty-3.1.21, created on 2016-12-28 21:10:11
         compiled from "/home/wwwroot/default/whmcs/templates/orderforms/thememetro-d-plus/checkout.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6110061625863b9b3a797d0-71715349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25e26c03843d8ce8ec475f7e9d0ff69a8502112a' => 
    array (
      0 => '/home/wwwroot/default/whmcs/templates/orderforms/thememetro-d-plus/checkout.tpl',
      1 => 1449785158,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6110061625863b9b3a797d0-71715349',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5863b9b3c486d2_94877768',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5863b9b3c486d2_94877768')) {function content_5863b9b3c486d2_94877768($_smarty_tpl) {?><?php echo '<script'; ?>
>
...
?>
											<div class="col-sm-6">
												<div class="form-group">
													<label for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['customfield']->value['name'];?>
</label>
                ...
                <?php if ($_smarty_tpl->tpl_vars['domainsinorder']->value) {?>
					...
					<div class="row">
						<div class="col-sm-12">
							<p class="small text-muted" style="margin-bottom: 20px;"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['orderForm']['domainAlternativeContact'];?>
</p>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<textarea name="notes" class="field" rows="4" onFocus="if(this.value=='<?php echo $_smarty_tpl->tpl_vars['LANG']->value['ordernotesdescription'];?>
'){this.value='';}" onBlur="if (this.value==''){this.value='<?php echo $_smarty_tpl->tpl_vars['LANG']->value['ordernotesdescription'];?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['ordertos'];?>
                    ...
                    <input type="submit" id="btnCompleteOrder" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['completeorder'];?>
" class="btn btn-primary btn-lg"<?php if ($_smarty_tpl->tpl_vars['cartitems']->value==0) {?> disabled="disabled"<?php }?> onclick="this.value='<?php echo $_smarty_tpl->tpl_vars['LANG']->value['pleasewait'];?>
'" />
                </div>
            </form>
