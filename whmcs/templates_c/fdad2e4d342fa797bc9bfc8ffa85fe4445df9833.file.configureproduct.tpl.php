<?php /* Smarty version Smarty-3.1.21, created on 2016-12-28 20:33:59
         compiled from "/home/wwwroot/default/whmcs/templates/orderforms/modern/configureproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8313046335863b137043a41-17679268%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdad2e4d342fa797bc9bfc8ffa85fe4445df9833' => 
    array (
      0 => '/home/wwwroot/default/whmcs/templates/orderforms/modern/configureproduct.tpl',
      1 => 1460367248,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8313046335863b137043a41-17679268',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5863b137188cc8_40420979',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5863b137188cc8_40420979')) {function content_5863b137188cc8_40420979($_smarty_tpl) {?><div id="prodconfigcontainer">
<?php echo '<script'; ?>
...
<table width="100%" cellspacing="0" cellpadding="0" class="configtable">
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['monthly']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle1" value="monthly"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="monthly") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle1" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['monthly'];?>
</label>
            </td>
        </tr>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['quarterly']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle2" value="quarterly"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="quarterly") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle2" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['quarterly'];?>
</label>
            </td>
        </tr>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['semiannually']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle3" value="semiannually"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="semiannually") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle3" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['semiannually'];?>
</label>
            </td>
        </tr>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['annually']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle4" value="annually"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="annually") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle4" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['annually'];?>
</label>
            </td>
        </tr>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['biennially']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle5" value="biennially"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="biennially") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle5" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['biennially'];?>
</label>
            </td>
        </tr>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pricing']->value['triennially']) {?>
        <tr>
            <td class="radiofield">
                <input type="radio" name="billingcycle" id="cycle6" value="triennially"<?php if ($_smarty_tpl->tpl_vars['billingcycle']->value=="triennially") {?> checked<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['configurableoptions']->value) {?>updateConfigurableOptions(<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
, this.value)<?php } else { ?>recalctotals()<?php }?>" />
            </td>
            <td class="fieldarea">
                <label for="cycle6" class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['pricing']->value['triennially'];?>
</label>
            </td>
        </tr>
    <?php }?>
