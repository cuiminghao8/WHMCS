<?php /* Smarty version Smarty-3.1.21, created on 2016-12-28 21:03:50
         compiled from "/home/wwwroot/default/whmcs/admin/templates/NeWorld/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20041135835863b836187d92-81080222%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6be466c6115222165774a7cd50a67a1cc4d5e974' => 
    array (
      0 => '/home/wwwroot/default/whmcs/admin/templates/NeWorld/menu.tpl',
      1 => 1466917066,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20041135835863b836187d92-81080222',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5863b8364741d1_05208107',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5863b8364741d1_05208107')) {function content_5863b8364741d1_05208107($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/wwwroot/default/whmcs/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?><div class="navigation">
	<div class="bodyContentWrapper">
<ul id="menu">
<li class="navbar"><a class="navlink first" class="navlink first" class="navlink first" id="Menu-Clients" <?php if (in_array("List Clients",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="clients.php"<?php }?> title="Clients"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Orders" <?php if (in_array("View Orders",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="orders.php"<?php }?> title="Orders"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Billing" <?php if (in_array("List Transactions",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="transactions.php"<?php }?> title="Billing"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['billing']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Support" <?php if (in_array("Support Center Overview",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="supportcenter.php"<?php }?> title="Support"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Reports" title="Reports" href="reports.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['reports']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Utilities" title="Utilities" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Addons" title="Addons" href="addonmodules.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['addonmodules'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Setup" title="Setup" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['setup']['title'];?>
</a>
  <ul>
...
<li class="navbar"><a class="navlink first" id="Menu-Help" title="Help" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['title'];?>
</a>
  <ul>
