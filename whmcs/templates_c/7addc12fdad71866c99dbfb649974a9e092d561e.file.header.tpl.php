<?php /* Smarty version Smarty-3.1.21, created on 2016-12-29 16:16:32
         compiled from "/home/wwwroot/default/whmcs/templates/flathost/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11048428425864c66043edf8-43546400%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7addc12fdad71866c99dbfb649974a9e092d561e' => 
    array (
      0 => '/home/wwwroot/default/whmcs/templates/flathost/header.tpl',
      1 => 1437999812,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11048428425864c66043edf8-43546400',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5864c660548804_95072032',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5864c660548804_95072032')) {function content_5864c660548804_95072032($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
" />
 ...
 &bull; <a href="pwreset.php"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['forgotpw'];?>
</a>
                            </label>
                        </form>
                         <?php if ($_smarty_tpl->tpl_vars['condlinks']->value['allowClientRegistration']) {?>
                        <hr />
                        <?php echo WHMCS\Smarty::sprintf2Modifier($_smarty_tpl->tpl_vars['LANG']->value['newcustomersignup'],'<a href="register.php">','</a>');?>
            ...
            <!-- Shopping Cart -->
            <div class="pull-right nav">
                <a href="cart.php?a=view" class="quick-nav"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['viewcart'];?>
...
<nav class="navbar navbar-default navbar-static-top" role="navigation"> 
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"> <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
    ...
    <div class="row">
        <div class="col-sm-3 col-xs-6" onclick="window.location='clientarea.php?action=services'">
            <div class="tile services-stats"><a href="clientarea.php?action=services">
                            ...
                            <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['navservices'];?>
 <span>→</span> </div>
                         </a></div>
        </div>
        <?php if ($_smarty_tpl->tpl_vars['registerdomainenabled']->value||$_smarty_tpl->tpl_vars['transferdomainenabled']->value) {?>
            <div class="col-sm-3 col-xs-6" onclick="window.location='clientarea.php?action=domains'">
                <div class="tile domains-stats"><a href="clientarea.php?action=domains">
                                    ...
                                    <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['navdomains'];?>
 <span>→</span> </div>
                                 </a></div>
            </div>
        <?php } elseif ($_smarty_tpl->tpl_vars['condlinks']->value['affiliates']&&$_smarty_tpl->tpl_vars['clientsstats']->value['isAffiliate']) {?>
            <div class="col-sm-3 col-xs-6" onclick="window.location='affiliates.php'">
                <div class="tile domains-stats"><a href="affiliates.php">
                                    ...
                                    <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['affiliatessignups'];?>
 <span>→</span> </div>
                                 </a></div>
            </div>
        <?php } else { ?>
            <div class="col-sm-3 col-xs-6" onclick="window.location='clientarea.php?action=quotes'">
               <div class="tile domains-stats"> <a href="clientarea.php?action=quotes">
                                   ...
                                   <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['quotes'];?>
 <span>→</span> </div>
                                </a></div>
            </div>
        <?php }?>
        <div class="col-sm-3 col-xs-6" onclick="window.location='supporttickets.php'">
           <div class="tile tickets-stats"> <a href="supporttickets.php">
                           ...
                           <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['navtickets'];?>
 <span>→</span> </div>
                        </a></div>
        </div>
        <div class="col-sm-3 col-xs-6" onclick="window.location='clientarea.php?action=invoices'">
           <div class="tile invoices-stats"> <a href="clientarea.php?action=invoices">
                           ...
                           <div class="title stats-head"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['navinvoices'];?>
<span>→</span> </div>
                        </a></div>
        </div>
    </div>
...
<section id="main-body" class="container">
    ...
    <div class="row">
        ...
        <div class="<?php if ($_smarty_tpl->tpl_vars['primarySidebar']->value->hasChildren()||$_smarty_tpl->tpl_vars['secondarySidebar']->value->hasChildren()) {?>col-md-9 pull-md-right<?php } else { ?>col-xs-12<?php }?> main-content">
            <?php if (!$_smarty_tpl->tpl_vars['primarySidebar']->value->hasChildren()&&!$_smarty_tpl->tpl_vars['showingLoginPage']->value&&$_smarty_tpl->tpl_vars['templatefile']->value!='homepage') {?>
                <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['template']->value)."/includes/pageheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->tpl_vars['displayTitle']->value,'desc'=>$_smarty_tpl->tpl_vars['tagline']->value,'showbreadcrumb'=>true), 0);?>
