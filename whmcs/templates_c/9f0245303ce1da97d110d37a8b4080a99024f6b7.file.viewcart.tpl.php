<?php /* Smarty version Smarty-3.1.21, created on 2016-12-28 21:10:05
         compiled from "/home/wwwroot/default/whmcs/templates/orderforms/thememetro-d-plus/viewcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4712322075863b9ad4b0366-19688415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9f0245303ce1da97d110d37a8b4080a99024f6b7' => 
    array (
      0 => '/home/wwwroot/default/whmcs/templates/orderforms/thememetro-d-plus/viewcart.tpl',
      1 => 1450266608,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4712322075863b9ad4b0366-19688415',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5863b9ad6a9271_81538102',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5863b9ad6a9271_81538102')) {function content_5863b9ad6a9271_81538102($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("orderforms/".((string)$_smarty_tpl->tpl_vars['carttpl']->value)."/common.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="header-lined">
                    <h1><?php if (!$_smarty_tpl->tpl_vars['checkout']->value) {
echo $_smarty_tpl->tpl_vars['LANG']->value['cartreviewcheckout'];
} else {
echo $_smarty_tpl->tpl_vars['LANG']->value['orderForm']['checkout'];
}?></h1>
                </div>
            ...
            <div class="col-md-12"  style="position:relative;">
                ...
                <div class="row">
                    <div class="col-md-9">
						<?php if ($_smarty_tpl->tpl_vars['checkout']->value) {?> <?php } else { ?>
...
')">
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['product']->value['domain']) {?>
                                                    <span class="item-domain">
                                                        <i><?php echo $_smarty_tpl->tpl_vars['product']->value['domain'];?>
</i>
                                                    </span>
                                                <?php }?>
...
<br /><?php }?>
                                ...
                                <div class="text-right">
                                    <?php if ($_smarty_tpl->tpl_vars['checkout']->value) {
} else { ?><a href="cart.php?a=checkout" class="btn btn-success btn-lg btn-checkout<?php if ($_smarty_tpl->tpl_vars['cartitems']->value==0) {?> disabled<?php }?>" id="checkout">
		...
		<div class="alert alert-warning" style="margin-top: 30px; font-size: 90%;">
            <i class="fa fa-lock"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['ordersecure'];?>
